...
{
    public class PT_MC_ALMEX_InputResult
    {
        public PT_MC_ALMEX_InputResult()
        {
            this.PT_MC_ALMEX_InputResultList = new List<PT_MC_ALMEX_InputResult>();
        }
        public List<PT_MC_ALMEX_InputResult> PT_MC_ALMEX_InputResultList { get; set; }
