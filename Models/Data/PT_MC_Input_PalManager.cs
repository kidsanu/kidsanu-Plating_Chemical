...
{
    public class PT_MC_Input_PalManager : BaseManager
    {
        int MaxTranId;

        //,string[] strRep, double[] douActual
        public int AddDataAnalysis(PT_MC_PAL_InputResult objpt1, int intNo, string[] strMachineCode, string[] strPart, string[] strCheme_id, string[] strRemark, decimal[] deTritrate, string[] strWork)
        {
        ...
        public PT_MC_PAL_InputResult GetDataPal(string MC_Code, PT_MC_PAL_InputResult spt1, string[] strchemicalTank, string[] stranalysisItem, string Tritrate1, string ResultCal, string Tritrate2, string ResultCal2, string Tritrate3, string ResultCal3, string Tritrate4, string ResultCal4, string Tritrate5, string ResultCal5, string Tritrate6, string ResultCal6, string Tritrate7, string ResultCal7, string Tritrate8, string ResultCal8, string Tritrate9, string ResultCal9, string Tritrate10, string ResultCal10, string Tritrate11, string ResultCal11)
        {
            ...
            try
            {
                ...
                ad.Fill(dt);
                result = new PT_MC_PAL_InputResult();
                ...
                {
                    result.strPartNoPal[i] = dtRow["PART_NO"].ToString();
                    result.strMachineCodePal[i] = dtRow["MACHINE_CODE"].ToString();
                    result.strchemicalTankPal[i] = dtRow["CHEMICAL_TANK"].ToString();
                    result.stranalysisItemPal[i] = dtRow["CHEMICAL_NAME"].ToString();
                    result.strchemicalTank_idPal[i] = dtRow["CHEMICAL_TANK_ID"].ToString();
                    result.strRemarkPal[i] = dtRow["REMARK"].ToString();
                    result.intNoPal[i] = i + 1;
                    i++;
                ...
                int t = Convert.ToInt32(result.intNoPal.Length.ToString());

                for (i = 0; i < t; i++)
                {
                    AddDataAnalysis(spt1, i, result.strMachineCodePal, result.strPartNoPal, result.strchemicalTank_idPal, result.strRemarkPal, TempTritrate, TempWorking);
                }
                // AddDataAnalysis();
        ...
        public PT_MC_PAL_InputResult GetDataPal(PT_MC_PAL_InputResult objcal, string MC_Code)
        {
            int i = 0;
            PT_MC_PAL_InputResult result = null;
            string strSql = "";
        ...
        public List<PT_MC_PAL_InputResult> GetPT_MC_InputInfoPal(string MC_Code)
        {
            string strSql = "";
            ...
            List<PT_MC_PAL_InputResult> list = new List<PT_MC_PAL_InputResult>();
            OracleConnection conn = new OracleConnection(this.ConnectionString);
            OracleCommand cmd = null;
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    PT_MC_PAL_InputResult item = new PT_MC_PAL_InputResult();
        ...
        public PT_MC_PAL_InputResult GetPT_MC_ChemicalInfos_ByDatailPal(int? id)
        {

            //PT_MC_InputResult result = null;
            PT_MC_PAL_InputResult items = new PT_MC_PAL_InputResult();
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    items = new PT_MC_PAL_InputResult();
        ...
        //Test
        public PT_MC_PAL_InputResult GetPT_MC_ChemicalInfos_ByHistoryPal(PT_MC_PAL_InputResult objcal, int? id)
        {
            int i = 0;
            PT_MC_PAL_InputResult result = null;
            string strSql = "";
            ...
            try
            {
                ...
                //    case "PLEP03A":
                        ...
                        foreach (DataRow dtRow in dt.Rows)
                        {
                            result.strchemicalTankPal[i] = dtRow["chemical_tank_name"].ToString();
                            result.strPartNoPal[i] = dtRow["PART_NO"].ToString();
                            result.strMachineCodePal[i] = dtRow["MACHINE_CODE"].ToString();
                            //result.strchemicalTank[i] = dtRow["CHEMICAL_TANK"].ToString();
                            result.stranalysisItemPal[i] = dtRow["CHEMICAL_NAME"].ToString();
                            result.strchemicalTank_idPal[i] = dtRow["CHEMICAL_TANK_ID"].ToString();
                            result.douTritratePal[i] = Convert.ToDouble(dtRow["TRITRATE"].ToString());
                            result.strWorkPal[i] = dtRow["WORKING"].ToString();
                            result.strRemarkPal[i] = dtRow["REMARK"].ToString();
                            result.intNoPal[i] = i + 1;
                            i++;
        ...
        public int UpdateDataInputResult(int id, PT_MC_PAL_InputResult res)
        {
            int result = 0;
            string strSQL = "";
        ...
        //Graph Pal Date : 28-Aug-2020
        public PT_MC_PAL_InputResult GetGraphPal(string MC_code,PT_MC_PAL_InputResult objpt)
        {
            //int i = 0;
            PT_MC_PAL_InputResult result = null;
            ...
            try
            {
                ...
                //Copper Cu
                result.strDailyX_Copper = dtCloned.AsEnumerable().Where(p => p.Field<string>("PART_NO") == "NOT_FILL" && p.Field<string>("CHEMICAL_TANK_ID") == "CMT00006" && (p.Field<string>("TIMED") == "10:00" || p.Field<string>("TIMED") == "18:00" || p.Field<string>("TIMED") == "22:00" || p.Field<string>("TIMED") == "06:00")).Select(p => p.Field<string>("DATED")).ToArray();
                result.douH_Copper = dtCloned.AsEnumerable().Where(p => p.Field<string>("PART_NO") == "NOT_FILL" && p.Field<string>("CHEMICAL_TANK_ID") == "CMT00006" && (p.Field<string>("TIMED") == "10:00" || p.Field<string>("TIMED") == "18:00" || p.Field<string>("TIMED") == "22:00" || p.Field<string>("TIMED") == "06:00")).Select(p => p.Field<double>("ACT_HIGH")).ToArray();
                result.douM_Copper = dtCloned.AsEnumerable().Where(p => p.Field<string>("PART_NO") == "NOT_FILL" && p.Field<string>("CHEMICAL_TANK_ID") == "CMT00006" && (p.Field<string>("TIMED") == "10:00" || p.Field<string>("TIMED") == "18:00" || p.Field<string>("TIMED") == "22:00" || p.Field<string>("TIMED") == "06:00")).Select(p => p.Field<double>("WORKING")).ToArray();
                result.douL_Copper = dtCloned.AsEnumerable().Where(p => p.Field<string>("PART_NO") == "NOT_FILL" && p.Field<string>("CHEMICAL_TANK_ID") == "CMT00006" && (p.Field<string>("TIMED") == "10:00" || p.Field<string>("TIMED") == "18:00" || p.Field<string>("TIMED") == "22:00" || p.Field<string>("TIMED") == "06:00")).Select(p => p.Field<double>("ACT_LOW")).ToArray();
